...
class ZoosControllerTest < ActionController::TestCase
  ...
  test "should create zoo" do
    assert_difference('Zoo.count') do
      post :create, zoo: { age: @zoo.age, animal: @zoo.animal, available: @zoo.available, born: @zoo.born }
    end
  ...
  test "should update zoo" do
    patch :update, id: @zoo, zoo: { age: @zoo.age, animal: @zoo.animal, available: @zoo.available, born: @zoo.born }
    assert_redirected_to zoo_path(assigns(:zoo))
  end
